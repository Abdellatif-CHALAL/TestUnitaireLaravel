...
class UserControllerTest extends TestCase
{
    ...
    {
        $this->data['email'] = "first_name@gmail.com";
    ...
    {
        $this->data['email'] = "first_last@gmail.com";
        $this->data['first_last'] = "";
        $this->post(route('users.store'), $this->data)
            ->assertStatus(400)
            ->assertJson(["message" => "First Name is empty"]);
    }

    public function test_create_user_with_empty_last_email()
    {
        $this->data['email'] = "first_last@gmail.com";
        $this->data['first_last'] = "";
        $this->post(route('users.store'), $this->data)
