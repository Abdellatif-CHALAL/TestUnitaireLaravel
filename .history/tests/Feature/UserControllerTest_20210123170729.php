...
class UserControllerTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->data = [
            ...
            "last_name" => "chalal",
            "date_naissance" => Carbon::now()->subYears(13),
            "email" => "ladfdl@gmail.com",
    ...
    public function test_create_user_with_invalid_birthday()
    {
        ...
        $this->data['date_naissance'] = "date_naissance" => Carbon::now()->subYears(13);
        $this->post(route('users.store'), $this->data)
            ->assertStatus(400)
            ->assertJson(["message" => "You must have more 13 years"]);
    }
}
