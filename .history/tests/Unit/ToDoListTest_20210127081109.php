...
class ToDoListTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->user->todolist->expects($this->any())->method('getLastItem')->willReturn($this->item);
        $this->user->todolist->expects($this->any())->method('sendEmailToUser')->willReturn(true);
        $this->user->todolist->expects($this->any())->method('saveItemInDataBase')->willReturn(true);
    }
